...
# 챗봇 엔진 서버 접속 정보
host = "192.249.18.137"  # 챗봇 엔진 서버 IP 주소
port = 443  # 챗봇 엔진 서버 통신 포트
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=443, ssl_context=('/etc/letsencrypt/live/w3.madcampai.kro.kr/fullchain.pem', '/etc/letsencrypt/live/w3.madcampai.kro.kr/privkey.pem'))
